...
import { Copy, CheckCheck, Key } from 'lucide-react';
...
export default function EmployeeCodeDisplay({ code }: EmployeeCodeDisplayProps) {
  ...
  return (
    <div className="bg-primary/10 border border-primary/30 rounded-xl p-6 flex flex-col gap-4">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-display font-semibold text-foreground">{t('staffRegistration.codeTitle')}</h3>
      </div>
